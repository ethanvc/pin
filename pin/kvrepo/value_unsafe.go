...
func (v Value) group() []Kv {
	if sp, ok := v.any.(groupptr); ok {
		return unsafe.Slice((*Kv)(sp), v.num)
	}
	panic("Group: bad kind")
}

func (v Value) uncheckedGroup() []Kv {
	return unsafe.Slice((*Kv)(v.any.(groupptr)), v.num)
}
